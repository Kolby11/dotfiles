// Auto-generated by matugen - Material You colors from wallpaper
pragma Singleton
import QtQuick
...
QtObject {
    ...
    readonly property color windowText: onBackground
    readonly property color panelBackground: surface
    readonly property color panelText: onSurface
    readonly property color cardBackground: surfaceContainer
    readonly property color cardText: onSurface
    readonly property color buttonBackground: primary
    readonly property color buttonText: onPrimary
    readonly property color accentColor: primary
    readonly property color textColor: onBackground
    readonly property color borderColor: outline
    
    // Transparency variants (optional)
    readonly property color primaryTransparent: Qt.rgba(
        Qt.darker(primary, 1).r,
        Qt.darker(primary, 1).g,
        Qt.darker(primary, 1).b,
        0.8
    )
    
    readonly property color surfaceTransparent: Qt.rgba(
        Qt.darker(surface, 1).r,
        Qt.darker(surface, 1).g,
        Qt.darker(surface, 1).b,
        0.9
    )
    
    readonly property color backgroundTransparent: Qt.rgba(
        Qt.darker(background, 1).r,
        Qt.darker(background, 1).g,
        Qt.darker(background, 1).b,
        0.95
    )
}